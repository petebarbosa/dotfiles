...
- `/home/petebarbosa/.config/opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/home/petebarbosa/.config/opencode/context/core/workflows/task-delegation.md` → Delegation process
- `/home/petebarbosa/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `/home/petebarbosa/.config/opencode/context/core/workflows/code-review.md` → Code review guidelines
